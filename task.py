...
def start_subclip(task_id: str, params: VideoClipParams, subclip_path_videos: dict = None):
    ...
    package_dir = jianying_export.export_jianying_import_package(
        task_id=task_id,
    ...
    draft_project_dir = jianying_export.export_jianying_draft_project(
        task_id=task_id,
        final_video_paths=final_video_paths,
    )
    ...
    kwargs = {
        ...
        "jianying_import_package": package_dir or "",
        "jianying_draft_project": draft_project_dir or "",
    }
